...
public class TutorialController {
    ...
    public Moduledetails addModule(@RequestBody Moduledetails module,@PathVariable("title") String title) {
    	return tutorialServiceimpl.addModule(module,title);
    }
    
    @PutMapping("/add/Topic/{title}")
	public Moduledetails addTopicToModule(@PathVariable String title,@RequestParam String topic) {
		return tutorialServiceimpl.addTopicToModule(title,topic);
	}
